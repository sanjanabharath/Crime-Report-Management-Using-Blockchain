...
import Complaint from "./OfficialComplaint";
import Profile from "./OfficialRecent";
import Recent from "./OfficialProfile";
...
const Official = () => {
  ...
  return (
    <div className="flex">
      ...
      {current == "recent" && <Profile />}
      {current == "profile" && <Recent />}
    </div>
  );
};
